...
// Hero + story imagery (license-clean stock stand-ins; swap for the café's own).
export const heroImage = {
  src: "/images/hero-macarons.jpg",
  alt: "Close-up of assorted pastel French macarons",
};

export const aboutImages = {
  counter: { src: "/images/cafe-interior.jpg", alt: "Warm café interior with wood floors and seating" },
  coffee: { src: "/images/coffee-latte.jpg", alt: "A cup of freshly brewed coffee with latte art" },
  macaron: { src: "/images/macarons-stack.jpg", alt: "A stack of pastel French macarons" },
};

// Signature products (all publicly attested items). `art`/`tone` drive the
// fallback tile; `img`/`alt` are the wired photograph.
export const featured = [
  {
    ...
    alt: "A stack of colourful French macarons",
    blurb:
  ...
  },
  {
    ...
    art: "cheesecake",
    tone: "rose",
    img: "/images/blueberry-cheesecake.jpg",
    alt: "A slice of blueberry cheesecake topped with blueberry compote",
    blurb:
  ...
  },
  {
    ...
    art: "cakeSlice",
    tone: "cocoa",
    img: "/images/chocolate-pastry.jpg",
    alt: "An elegant layered chocolate pastry",
    blurb:
...
export const gallery = [
  { art: "macaron", tone: "blush", span: "tall", img: "/images/macarons-rainbow.jpg", alt: "A row of rainbow-coloured French macarons", photo: "Tower of assorted macarons, soft daylight" },
  { art: "coffee", tone: "cocoa", span: "short", img: "/images/coffee-latte.jpg", alt: "Coffee with latte art in a white cup", photo: "Latte art in a ceramic cup, overhead" },
  { art: "cakeSlice", tone: "caramel", span: "short", img: "/images/cake-slice.jpg", alt: "A slice of layered cake on a plate", photo: "Slice of layered chocolate cake on a plate" },
  { art: "croissant", tone: "sand", span: "tall", img: "/images/croissants-tray.jpg", alt: "A tray of freshly baked croissants", photo: "Basket of golden croissants, morning light" },
  { art: "cupcake", tone: "rose", span: "short", img: "/images/cupcakes.jpg", alt: "Cupcakes topped with swirled cream", photo: "Piped cupcakes on a marble counter" },
  { art: "cheesecake", tone: "blush", span: "tall", img: "/images/cheesecake-berry.jpg", alt: "A slice of cheesecake with berries", photo: "Whole blueberry cheesecake, styled" },
  { art: "sparkle", tone: "gold", span: "short", img: "/images/cafe-counter.jpg", alt: "Café counter with coffee menu and pastry display", photo: "Café interior — art-lined warm walls" },
  { art: "whisk", tone: "cocoa", span: "short", img: "/images/chef-piping.jpg", alt: "A pastry chef piping and finishing a dessert", photo: "Pastry chef finishing a dessert, candid" },
];
...
export const seasonal = {
  ...
  img: "/images/sparkler-cake.jpg",
  alt: "A celebration cake lit with a sparkler",
